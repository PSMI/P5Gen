                        ...
                        array('class'=>'bootstrap.widgets.TbButtonColumn',
                            ...
                            (
                                ...
                                (
                                    'label'=>'Approve',
                                    'icon'=>'ok-sign',
                                    'url'=>'Yii::app()->createUrl("/admintransactions/processtransaction", array("id" =>$data["distributor_commission_id"], "status" => "1", "transtype" => "iborpcommission"))',
                                ...
                                (
                                    'label'=>'Claim',
                                    'icon'=>'ok-sign',
                                    'url'=>'Yii::app()->createUrl("/admintransactions/processtransaction", array("id" =>$data["distributor_commission_id"], "status" => "2", "transtype" => "iborpcommission"))',
                                ...
                                (
                                    ...
                                    'url'=>'Yii::app()->createUrl("/admintransactions/pdfiborpcommission", array("id" =>$data["distributor_commission_id"], "cutoff_id" =>$data["cutoff_id"], "member_id" =>$data["member_id"], "commission_amount" => $data["commission_amount"], "account_type_id" => $data["account_type_id"]))',
                                    'options' => array(
                                        'class'=>"btn btn-small",
                                    ),
                                    array('id' => 'send-link-'.uniqid())
