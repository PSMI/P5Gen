                        ...
                        array('class'=>'bootstrap.widgets.TbButtonColumn',
                            ...
                            (
                                ...
                                (
                                    ...
                                    'url'=>'Yii::app()->createUrl("/admintransactions/pdfiborpcommission", array("id" =>$data["distributor_commission_id"], "cutoff_id" =>$data["cutoff_id"], "member_id" =>$data["member_id"], "commission_amount" => $data["commission_amount"]))',
                                    'options' => array(
                                        'class'=>"btn btn-small",
                                    ),
                                    array('id' => 'send-link-'.uniqid())
