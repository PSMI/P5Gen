...
$this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'columns' => array(
                        ...
                        array('name'=>'GeneratedCodes',
                            'header'=>'Generated Codes',
                            'type'=>'raw',
                            'value'=>'CHtml::encode($data["batch_quantity"])',
                            'htmlOptions' => array('style' => 'text-align:center'), 
                            'headerHtmlOptions' => array('style' => 'text-align:center'),
                        ),
                        array('name'=>'AvailableCodes',
                            'header'=>'Available Codes',
                            'type'=>'raw',
                            'value'=>'CHtml::encode($data["available_codes"])',
                            'htmlOptions' => array('style' => 'text-align:center'), 
                            'headerHtmlOptions' => array('style' => 'text-align:center'),
                        ),
                        array('name'=>'DistributionTag',
                            'header'=>'Code Usage',
                            'type'=>'raw',
                            'value'=>'CHtml::encode($data["distribution_tag_id"])',
                            'htmlOptions' => array('style' => 'text-align:center'), 
                            'headerHtmlOptions' => array('style' => 'text-align:center'),
                        ),
