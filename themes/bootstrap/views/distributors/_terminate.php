 ...
 */
?>
<?php $this->breadcrumbs = array('Distributors'=>'#','Change Distributor Status'); ?>
...
<table style="width: auto;">
    <tr>
        <td><?php echo CHtml::label("Distributor Name", "txtName"); ?></td>
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
    ...
    'url'=>Yii::app()->createUrl("distributors/terminateSuccess"), 
    'label'=>'YES',
        'ajaxOptions'=>array(
            'type'=>'POST',
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
        'id'=>'success-box',
        'options'=>array(
            'title'=>'UPDATE DISTRIBUTOR STATUS',
            'modal'=>true,
            'width'=>'350',
            'height'=>'auto',
            'resizable'=>false,
