 ...
 */
?>
<?php $this->breadcrumbs = array('Distributors'=>'#','Update Distributor Profile'); ?>
...
?>
<h3>Update Distributor Profile</h3>
...
<table style="width: 100%;">
    ...
    <tr>
        <td>
            ...
            <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'button',  'type'=>'primary', 'label'=>'Back', 'htmlOptions'=>array('onclick'=>'location.href = "' . Yii::app()->createUrl("distributors/index") . '";'))); ?>
        </td>
    </tr>
</table>
...
<div align="right">
<?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'ajaxSubmit', 'url'=>Yii::app()->createUrl("distributors/updateSuccess"), 'label'=>'YES',
                                                                'ajaxOptions'=>array(
                                                                    'type'=>'POST',
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
        ...
        'options'=>array(
            ...
            'buttons'=>array(
                'OK'=>'js:function(){
                    location.href = "'. Yii::app()->createUrl('distributors/index') . '";
                }'
            )
        ),
)); ?>
